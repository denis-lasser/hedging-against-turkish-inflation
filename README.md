...
│                         hedging-against-turkish-inflation and configuration for tools like black
│
...
│
└── hedging-against-turkish-inflation   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes hedging-against-turkish-inflation a Python module
    │
